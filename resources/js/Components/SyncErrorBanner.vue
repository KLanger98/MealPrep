...
<template>
    <div v-if="errors.length && !dismissed" class="mb-4 rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-800 dark:bg-amber-950 dark:text-amber-200">
        <div class="flex items-center justify-between gap-4">
            ...
            <button type="button" class="text-amber-700 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-200" aria-label="Dismiss" @click="dismissed = true">✕</button>
        </div>
